...
<div class="container">
  ...
  <%
    ...
    PreparedStatement ps = conn.prepareStatement("SELECT status FROM cars WHERE id = ?");
    ps.setInt(1, carId);
  ...
  <form action="updatestatusAction.jsp" method="post" class="add-form">
    ...
    <select name="status" id="status">
      ...
      <option value="Booked" <%= "Booked".equals(currentStatus) ? "selected" : "" %>>Booked</option>
